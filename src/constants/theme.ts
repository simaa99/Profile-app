...
export const theme = {
  ...
  colors: lightColors,
  typography: {
    title1: { fontSize: rem(48), fontWeight: 800 },
    title2: { fontSize: rem(32), fontWeight: 800 },
    title3: { fontSize: rem(24), fontWeight: 800 },
    title4: { fontSize: rem(18), fontWeight: 800 },
    bodyLarge: { fontSize: rem(18), fontWeight: 400 },
    bodyLargeStrong: { fontSize: rem(18), fontWeight: 600 },
    body: { fontSize: rem(16), fontWeight: 400 },
    bodyStrong: { fontSize: rem(16), fontWeight: 600 },
    bodySmall: { fontSize: rem(12), fontWeight: 400 },
    bodySmallStrong: { fontSize: rem(12), fontWeight: 600 },
    caption: { fontSize: rem(10), fontWeight: 400 },
    overline: {
      fontSize: rem(10),
